        ...
        <div className="aspect-[4/3] bg-gradient-to-br from-green-50 to-emerald-50 relative overflow-hidden">
          ...
          {product.inStock ? (
            <div className="absolute top-4 left-4">
              <span className="bg-emerald-500 hover:bg-emerald-600 text-black px-3 py-1 rounded-full text-xs font-medium shadow-lg border border-emerald-400 transition-colors duration-200">
                Skladem
              </span>
            </div>
          ) : (
